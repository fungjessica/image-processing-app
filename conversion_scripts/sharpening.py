...
# take pics in grayscale on phone and apply colour here 
# subtract atmospheric turbluence from stacked image using stacked sky frames. 
# sky frames = take stacked image of sky near the object 
...
# load image
image_path = os.path.join("stacked_SSimages", "stacked_SSmoon.png") #change for other planets
...
if image is None:
    ...
    output_path = os.path.join("stacked_SSimages", "sharpened_SSmoon.png") #change for other planets
