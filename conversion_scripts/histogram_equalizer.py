...
image_path = "stacked_SSimages/stacked_SSjupiter.png" #change for other planets
image = cv2.imread(image_path)

output_path = "stacked_SSimages/constrast_SSjupiter.png" #change for other planets
